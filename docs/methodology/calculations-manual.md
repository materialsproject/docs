...
This manual explains our calculation methods, adjustments made to our
calculated energies, and errors in our calculations.
...
the [Calculations Wiki](/methodology/calculations-wiki).
...
We currently employ a k-point mesh of 1000/number of atoms. We performed
a convergence test of total energy with respect to <em>k</em> point
...
k-point mesh of 500/atom. Using 500/atom k-point mesh, the numerical
...
new parameter set will be better due to the higher k-point mesh
...
This data is available for many entries (a few thousands as for now) in
...
From this run the DOS and the charge density was extracted. The charge
density was used to perform then a band structure computation for
k-point along the symmetry lines of the Brillouin zone. The symmetry
...
according to the band structure and the nature of the gap (direct or
...
orbitals are available too through a scroll down menu. Please note that
the DOS data and band structure can be slightly different as the kpoint
...
*Figure 2: Experimental versus computed band gaps for
...
Chan for her assistance in compiling this
data.*
...
by about 40% (Figure 2). We additionally find that several known
