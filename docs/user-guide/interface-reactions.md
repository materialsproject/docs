...
This section shows how to interpret a reaction energy plot generated by Interface Reactions App. In the table presented below the plot, you can review, for each node in the plot, the corresponding quantities:
...
To illustrate the reaction information obtainable from the Interface Reactions app, we use Figure 1 as an example for $/ce{LiCoO2}-/ce{Li3PS4}$ system (closed to any element). $\ce{LiCoO2}$ and $\ce{Li3PS4}$ are commonly used cathode material and solid-state electrolyte material in Li-ion batteries, respectively. The cathode/electrolyte interface is of particular interest in battery research as it largely affects the battery performance.

Figure 1 shows the reactivity as a function of molar fraction $x$ of $\ce{LiCoO2}$. Table 1 also lists all the critical reaction equations, and corresponding molar fraction of first reactant and reaction energies per mole of reaction equation. There are 8 nodes which corresponds to 8 critical reactions. Each node is a kink point in the reactivity profile. For example, the second node from the left with molar fraction of $\ce{LiCoO2}$ 0.667 corresponds to the reaction:

![Figure 1](img/Fig1_plot_LiCoO2-Li3PS4_close_MP_release.png)
Figure 1. Calculated reactivity plot diagram for $\ce{LiCoO2}-\ce{Li3PS4}$ closed system

$$\ce{Li3PS4} + 2 \ce{LiCoO2} = 0.5 \ce{CoS2} + 0.5 \ce{Co3S4} +  \ce{Li3PO4} +  \ce{Li2S}$$

The reactivity for this node is -0.399 eV/atom. The reaction energy of the reaction above is -616.0 kJ/mol.

The largest reaction driving force (magnitude of reactivity) is found for two reactions with the molar fraction of $\ce{LiCoO2}$ being 0.686 and 0.742, respectively. The corresponding reactivity is -0.402 eV/atom.

![Table 1](img/Fig2_table_LiCoO2-Li3PS4_close_MP_release.png)
...
We use the same  $\ce{LiCoO2}-\ce{Li3PS4}$ system that open to Li reservoir to illustrate the reaction energy plot in open system. The Li reservoir is at 3 V vs. Li metal, i.e., the chemical potential of Li in the reservoir is 3 eV/atom lower than that in Li metal (corresponding to $\mu$ = -3 eV in the App).

![Figure 2](img/Fig3_plot_LiCoO2-Li3PS4_open_MP_release.png)
Figure 2. Calculated reaction energy plot diagram for $/ce{LiCoO2}-/ce{Li3PS4}$ system open to Li reservoir at 3 V vs. Li metal.
...
$$\ce{Li3PS4} = 2.875 \ce{Li} + 0.5 \ce{P2S7} + 0.125 \ce{LiS4}$$

Note that Li is extracted from the reactants to the Li reservoir. In contrast, $\ce{LiCoO2}$ is stable at this voltage as the reactivity is 0 eV/atom at $x = 1$. The interpretation of other reactions in the table is similar to those in the closed system.

![Table 2](img/Fig4_table_LiCoO2-Li3PS4_open_MP_release.png)
Table 2. Critical reaction information for $\ce{LiCoO2}-\ce{Li3PS4}$ system open to Li reservoir at 3 V vs. Li metal.
...
Since the Interface Reactions app is based on the analysis of the energy convex hull, compounds that are metastable may not show up in the reaction products, although they might be kinetically stabilized in experimental condition. Therefore, reactions not listed in the table are also possible to happen. Additionally, we caution that these reactions are all at the thermodynamic ground state (0 K and 0 atm) and do not account for kinetics. In practice, this app serves as a guideline for reactions expected to occur at solid-solid interfaces.
