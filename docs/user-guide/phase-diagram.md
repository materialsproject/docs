...
In this manual, we will outline the general usage and thermodynamics methodology of our computational phase diagrams app. The details of the calculations, including computational methodology and accuracy, used in constructing these phase diagrams are available in the [Calculations Manual](/methodology/total-energies "Calculations Manual") and will not be further covered in this manual.
